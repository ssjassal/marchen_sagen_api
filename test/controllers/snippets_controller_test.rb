...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { snip: @snippet.snip, story_id: @snippet.story_id, storyteller_id: @snippet.storyteller_id } }, as: :json
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { snip: @snippet.snip, story_id: @snippet.story_id, storyteller_id: @snippet.storyteller_id } }, as: :json
    assert_response 200
  end
